...
> - превью картинок теперь не на весь размер. Изменены максимальная высота и ширина
...
* Дизайн:
> - переработан внешний вид
> - появилось боковое меню. Отображается, если ширина экрана достигает 1030px и меньше
> - отображение имени автора и названия изображения, которое автор мог написать при добавлении изображения
> - изменен внешний вид сетки изображений
> - изменен внешний вид модального окна изображения
> - цвет акцента кнопок авторизации изменился на зелёный
* Анимации:
> - при уменьшеной ширине экрана все основные элементы (добавление, удаление, очистка, поиск, меню профиля) переносятся в сайдбар меню
> - изменение поведения шапки. При скролле страницы она опускается до начала надписи "Простая Онлайн Галерея". Так основные элементы будут отображаться и при этом экономить основной контент
