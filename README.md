...
* Анимации: появилось затеменение изображений при наведении
* Функционал: добавлена возможность просмотреть только изображения профиля
* Функционал: добавлена кнопка удаления всех пользовательских изображений. Это не то же самое, что очистка всей галереи (доступна только для админа)
