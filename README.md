...
* Дизайн: основной цвет кнопок авторизации изменился на зелёный
...
* Удалена база данных с изображениями. Теперь эта дополненная таблица в account.db

Присутствует баг с превью изображеним. О проблеме известно, пофиксится в ближайшие дни или после выходных.
