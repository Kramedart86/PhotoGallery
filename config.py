...
app.config['MAIL_SERVER'] = 'smtp.yandex.ru'  # Адрес SMTP сервера (yandex.ru, google.com, mail.ru)
...
app.config['MAIL_USERNAME'] = 'sample@mail.com'  # Ваше почта на почтовом сервере
